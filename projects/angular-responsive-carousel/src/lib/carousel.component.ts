...
export class CarouselComponent implements OnDestroy {
    ...
    ngOnInit() {
        ...
        this.setDimensions();
        this.carouselService.performActionProgrammatically.subscribe((value: string) => {
          switch (value) {
            case 'NEXT':
              this.progNext();
              break;
    ...
    next() {
        this.carouselService.physicalActionPerformed.next("next");
    ...
    prev() {
        this.carouselService.physicalActionPerformed.next("previous");
